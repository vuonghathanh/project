...
@section('content')
    <div class="x_content">
        <form class="" action="/admin/room-types/{{$obj->id}}" method="post" id="hotel_form" novalidate>
            @method('PUT')
            @csrf
            ...
            <div class="field item form-group">
                ...
                <div class="col-md-6 col-sm-6">
                    <input class="form-control" name="type" type="text" value="{{$obj->type}}" required="required"/>
                </div>
            </div>
            <div class="field item form-group">
