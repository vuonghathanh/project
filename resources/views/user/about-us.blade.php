...
@section('content')
    ...
    <nav style="min-height: 500px;margin-top: 100px">
        <div class="container">
            <div class="row">
                <div class="col-12">
            ...
            <div class="row tt" style="margin-top: 130px">
                <div class="col-4">
                    ...
                    <div style="min-height: 150px">
                        <p><span>Chức vụ: Nhóm trưởng</span></p>
                        <p>Là người đưa ra các quan điểm và thông qua các ý kiến của các thành viên. Từ đó tóm tắt lại và đưa ra việc làm cụ thể cho cả nhóm.</p>
                    </div>
                    <p><span>Tính cách: </span> nhanh nhẹn, lanh lợi, hòa đồng, tích cực giúp đỡ bạn bè.   </p>
                    <p><span>Kỹ năng: </span> sử dụng thành thạo nhiều ngôn ngữ lập trình và có thể ứng dụng vào công việc thể hiện rõ nhất là ở dự án mô phỏng về website qua việc book phòng.</p>
                </div>
                <div class="col-4">
                    <div class="single-team">
                        <img src="https://res.cloudinary.com/huydeptrai/image/upload/v1597291323/add_kmj5jc.jpg" alt="">
                        <div class="team-text">
                            <h4>Member: Hoàng Xuân Huy</h4>
                            <p>Student: FPT Aptech</p>
                        </div>
                    </div>
                    <br>
                    <h4>Thông tin cá nhân: </h4>
                    <div style="min-height: 150px">
                        <p><span>Chức vụ: Thành viên</span></p>
                        <p>đóng góp ý kiến về việc làm trong tuần hoặc nhiệm vụ tuần tới và hoàn thành các nhiệm được giao trong tuần không được chậm làm ảnh hưởng đến các thành viên khác.</p>
                    </div>
