                            ...
                            <table border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                            ...
                                            <tr>
                                                <td align="left">
                                                    <table border="0" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <a href="http://127.0.0.1:8000/client/transaction/{{$transaction}}"
                                        ...
                                        <p><a href="http://127.0.0.1:8000/client/transaction/{{$transaction}}">http://127.0.0.1:8000/client/transaction/{{$transaction}}</a>
                                        </p>
                                    </td>
                                </tr>
                            </table>
